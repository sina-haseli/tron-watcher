import { Connection, EntitySchema, FindConditions, getConnection, ObjectType } from 'typeorm';
...
export abstract class UniqueValidator implements ValidatorConstraintInterface {
  protected constructor(protected readonly connection: Connection = getConnection('default')) {}
